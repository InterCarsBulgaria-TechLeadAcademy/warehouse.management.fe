...
interface GoodDetailsFormProps {
  ...
  setValue: UseFormSetValue<NewDeliveryStep3FormData>
...
export default function GoodDetailsForm({
  ...
  const [goodTypeValue, setGoodTypeValue] = React.useState<string | null>(
          ...
          <Autocomplete
            ...
            onChange={(_event: any, newValue: string | null) => {
              const selectedValue = newValue
                ...
                : null
              setGoodTypeValue(selectedValue)
              setValue(`goods.${index}.goodTypeStep3`, selectedValue as string) // Използваме setValue за актуализиране на стойността на полето
              field.onChange(selectedValue)
              onGoodTypeChange(selectedValue)
            }}
            sx={{ flex: 1 }}
            renderInput={(params) => (
              <TextField
